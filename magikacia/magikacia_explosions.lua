...
local function trace_explode(pos, strength, raydirs, radius, info, direct, source, typename, do_owner_damage)
...
function magikacia.explode(pos, strength, info, direct, source, typename, do_owner_damage)
    ...
    trace_explode(pos, strength, shape, radius, info, direct, source, typename, do_owner_damage)
